...
public class ResidentStyle implements MarkStyle<Resident>{
	 ...
	 */
	@Override
	public PlaceMark getPlaceMark(Resident agent, PlaceMark mark) {
...
//		}
	 ...
	 */
	@Override
	public double getScale(Resident agent) {
		return 0.1;

	}

	@Override
	public double getHeading(Resident agent) {
		return 0;
	}
	 ...
	 */
	@Override
	public String getLabel(Resident agent) {
//		return "" + agent.getWaterRate();
		return null;
	}

	@Override
	public Color getLabelColor(Resident agent) {
...
//		}
	 ...
	 */
	@Override
	public Offset getLabelOffset(Resident agent) {
		return labelOffset;
	}

	@Override
	public Font getLabelFont(Resident obj) {
		return null;
	}
	 ...
	 */
	@Override
	public double getLineWidth(Resident agent) {
		return 0;
//		if (agent.getPhCount() == 3){
//			return 2;
//		}
...
//		}
	...
	@Override
	public Material getLineMaterial(Resident obj, Material lineMaterial) {
	...
	@Override
	public Offset getIconOffset(Resident obj) {
