 ...
 *
 */
public class NodeStyle1 extends DefaultMarkStyle<Node>{
	...
	public WWTexture getTexture(Node agent, WWTexture texture) {
		...
		URL localUrl = WorldWind.getDataFileStore().requestFile("icons/Pole2.png");
		if (localUrl != null)	{
	...
	@Override
	public Offset getIconOffset(Node agent){
		return iconOffset;
	}
}