 ...
 *
 */
public class ParcelStationStyle extends DefaultMarkStyle<ParcelStation>{
	...
	public WWTexture getTexture(ParcelStation agent, WWTexture texture) {
		...
		URL localUrl = WorldWind.getDataFileStore().requestFile("icons/Station2.png");
		if (localUrl != null)	{
	...
	@Override
	public Offset getIconOffset(ParcelStation agent){
		return iconOffset;
	}
}